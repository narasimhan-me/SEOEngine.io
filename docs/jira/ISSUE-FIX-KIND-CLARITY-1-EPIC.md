...
Make the kind of fix (AI preview, direct/manual fix, guidance-only, blocked) explicit at the point of decision on the Issues page, so users understand what will happen before they click.
