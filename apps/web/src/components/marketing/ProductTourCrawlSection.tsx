      ...
      <div className="mx-auto max-w-6xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="grid gap-8 md:grid-cols-2 md:items-center">
          <div>
            ...
            <p className="mt-3 text-sm text-muted-foreground">A dedicated crawling system that finds:</p>
            ...
            <p className="mt-1 text-sm text-muted-foreground">No setup. No plugins. No code.</p>
          </div>
