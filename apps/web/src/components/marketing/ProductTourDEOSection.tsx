        ...
        <div className="flex-1 space-y-8">
          <div>
            ...
            <p className="mt-3 text-sm text-muted-foreground">
              EngineO.ai is not an SEO tool.
            </p>
            <p className="mt-2 text-sm text-muted-foreground">
              It is a DEO Platform &mdash; Discovery Engine Optimization &mdash;
              designed for the search + AI era.
            </p>
            ...
            <ol className="mt-2 list-decimal space-y-1 pl-5 text-sm text-muted-foreground">
              ...
              <li>
                Helps you optimize products, pages, blogs, and collections
              </li>
            </ol>
          </div>
          ...
          <div>
            ...
            <dl className="mt-4 grid gap-4 text-sm text-muted-foreground sm:grid-cols-2">
              ...
              <div>
                <dt className="font-semibold text-foreground">
                  Entities &amp; Semantic Signals
                </dt>
                <dd className="mt-1">
                  Metadata, headings, entity hints, topic relationships.
                </dd>
              </div>
              <div>
                <dt className="font-semibold text-foreground">
              ...
              <div>
                ...
                <dd className="mt-1">
                  Answer-surface potential, link structure, brand navigation.
                </dd>
              </div>
            </dl>
            <p className="mt-4 text-sm text-muted-foreground">
              The DEO Score gives you a single number representing your entire
              site&apos;s visibility across search engines and AI assistants.
            </p>
          </div>
        </div>
          ...
          <div className="flex h-full items-center justify-center rounded-2xl border border-dashed border-border bg-muted p-6">
            <div className="text-center text-xs text-muted-foreground">
              ...
              <p className="font-semibold text-muted-foreground">
                DEO Score visualization
              </p>
              <p className="mt-1">
                Placeholder for score dial or card showing Content, Entities,
                Technical, and Visibility components.
              </p>
            </div>
          </div>
        </div>
