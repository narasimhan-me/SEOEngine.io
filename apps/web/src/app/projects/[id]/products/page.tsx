...
export default function ProductsPage() {
  ...
  const filterIssueType =
    normalizedScopeResult.normalized.issueType || undefined;
  ...
  const handleClearFilters = useCallback(() => {
    ...
    router.replace(`/projects/${projectId}/products${qs ? `?${qs}` : ''}`, {
      scroll: false,
    });
          ...
          <div className="flex items-start justify-between">
            <div>
              ...
              <p className="mt-1 text-xs text-yellow-700">
                DEO Score and issues may be empty until you run your first
                crawl. After crawling, product issues will be surfaced in the{' '}
                <Link
              ...
              <div className="mt-3 flex flex-wrap gap-2">
                <button
                  onClick={() =>
                    router.push(
                      `/projects/${projectId}/store-health?focus=crawl`
                    )
                  }
