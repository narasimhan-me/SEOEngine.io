          ...
          <div className="flex items-start">
            ...
            <div className="ml-4 flex-1">
              ...
              <p className="text-gray-600 mt-1 mb-4">
                Browse our documentation, tutorials, and frequently asked
                questions.
              </p>
              <a
        ...
        <div className="bg-white shadow rounded-lg p-6">
          <div className="flex items-start">
            ...
            <div className="ml-4 flex-1">
              ...
              <p className="text-gray-600 mt-1 mb-4">
                Experiencing a bug or unexpected behavior? Let us know so we can
                fix it.
              </p>
              ...
              <div className="bg-yellow-50 rounded-lg p-4 mb-4">
                ...
                <p className="text-sm text-yellow-700">
                  ...
                  page first. Consider upgrading your plan or waiting for quota
                  reset.
                </p>
              </div>
        ...
        <div className="bg-white shadow rounded-lg p-6 border-2 border-gray-200 opacity-75">
          <div className="flex items-start">
            ...
            <div className="ml-4 flex-1">
              ...
              <p className="text-gray-600 mt-1 mb-4">
                New to EngineO? Soon you&apos;ll be able to complete your first
                DEO fix in 5-10 minutes with our guided onboarding. We&apos;ll
                help you identify your highest-impact opportunity and walk you
                through fixing it step by step.
              </p>
              ...
              <div className="bg-gray-50 rounded-lg p-4 mb-4">
                ...
                <ol className="text-sm text-gray-600 space-y-1 list-decimal list-inside">
                  ...
                  <li>
                    We&apos;ll identify your highest-impact DEO opportunity
                  </li>
              ...
              <p className="text-sm text-gray-500 mt-2">
                The guided onboarding feature is under development. In the
                meantime, explore your projects to get started!
              </p>
            </div>
          </div>
        </div>
